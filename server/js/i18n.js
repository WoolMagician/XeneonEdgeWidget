...
const i18n = {
  it: {
    ...
    tip_lock: 'Blocca schermo', tip_tabs: 'Apri tab', tip_focus_lock: 'Apri lock screen widget', tip_apps: 'Applicazioni aperte', tip_settings: 'Impostazioni aspetto', tip_media_mode: 'App media', tip_shortcut: 'Cambia uscita audio',
    ...
    media_apps_kicker: 'Media', media_apps_title: 'App media', media_apps_close: 'Chiudi',
    ...
    settings_media_mode: 'Modalita media', settings_media_mode_hint: 'Jellyfin e app web',
    settings_media_url: 'URL Jellyfin', settings_media_url_hint: 'usato dal tile Jellyfin',
  ...
  en: {
    ...
    tip_lock: 'Lock screen', tip_tabs: 'Open tabs', tip_focus_lock: 'Open widget lock screen', tip_apps: 'Open applications', tip_settings: 'Appearance settings', tip_media_mode: 'Media apps', tip_shortcut: 'Switch audio output',
    clock_ny_label: 'New York -4',
    ...
    media_apps_kicker: 'Media', media_apps_title: 'Media apps', media_apps_close: 'Close',
    ...
    settings_media_mode: 'Media mode', settings_media_mode_hint: 'Jellyfin and web apps',
    settings_media_url: 'Jellyfin URL', settings_media_url_hint: 'used by the Jellyfin tile',
    settings_media_url_placeholder: 'https://jellyfin.local/web/#/home.html',
